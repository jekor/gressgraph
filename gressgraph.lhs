...
> showChain (name, rules)  =   concatMap  (showRule name) (zip colors rules)
...
>                     "// Interfaces\n",
>                     concatMap interfaceNode (zip interfaces interfaceSizes),
>                     concatMap toRoot interfaces,
>                     "// Addresses\n",
>                     concatMap addressNode (zip addresses addressSizes),
>                     "// Rules",
>                     concatMap showChain cs,
>                     "\n}\n"]
>     where
